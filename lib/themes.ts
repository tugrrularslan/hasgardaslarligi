...
export const appThemes: AppTheme[] = [
  {
    ...
    primaryButtonClass: "hg-primary border border-amber-300/50 bg-gradient-to-r from-amber-500 to-yellow-300 text-black shadow-lg hover:brightness-110",
    secondaryButtonClass: "hg-secondary border border-amber-400/45 bg-black/35 text-amber-200 hover:bg-amber-400/10",
  ...
  },
  {
    ...
    primaryButtonClass: "hg-primary border border-yellow-300/50 bg-gradient-to-r from-[#777c25] to-[#bfa64d] text-[#111407] shadow-lg hover:brightness-110",
    secondaryButtonClass: "hg-secondary border border-yellow-500/40 bg-[#111707]/45 text-yellow-200 hover:bg-lime-500/10",
  ...
  },
  {
    ...
    primaryButtonClass: "hg-primary border border-[#78451d]/45 bg-gradient-to-r from-[#8a5528] to-[#bd8c4b] text-white shadow-lg hover:brightness-110",
    secondaryButtonClass: "hg-secondary border border-[#78451d]/45 bg-[#f8e6c6]/55 text-[#5f3518] hover:bg-[#d8b783]/35",
  ...
  },
  {
    ...
    primaryButtonClass: "hg-primary border border-orange-400/50 bg-gradient-to-r from-[#8d3514] to-[#d56f2b] text-white shadow-lg hover:brightness-110",
    secondaryButtonClass: "hg-secondary border border-orange-500/40 bg-black/35 text-orange-300 hover:bg-orange-500/10",
